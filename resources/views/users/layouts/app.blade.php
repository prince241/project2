...
<head>
    ...
    <!-- END: Custom CSS-->
    <link rel="stylesheet" href="../../../app-assets/vendors/css/forms/wizard.css" >
...
@include('users.layouts.sidebar')
  ...
  <div class="app-content content">
    ...
    {{-- <script src="../../../app-assets/js/step-checkout.js"></script> --}}
    ...
    <script src="../../../app-assets/js/scripts/datatables/user-datatable.js"></script>
