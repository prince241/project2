         ...
         <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            <li class=" nav-item">
                <a href="index.html">
                    ...
                    <a class="btn btn-primary text-white mb-2 float-left modal-button" href="{{ route('products.create') }}">
                        <span class="menu-title" data-i18n="Add product"> Add product </span></a>
            </li>
        </ul> 
    </div>
</div>
